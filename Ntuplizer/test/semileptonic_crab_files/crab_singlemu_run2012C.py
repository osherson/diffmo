...
config.General.requestName = 'SingleMu_Run2012C_v1'
...
config.Data.inputDataset = '/SingleMu/StoreResults-V2-Run2012C-22Jan2013-v1_TLBSM_53x_v3-db7dd8e58134469d4e102fe8d5e205b6/USER'
config.Data.unitsPerJob = 80
config.Data.splitting = 'LumiBased'
config.Data.lumiMask = '../Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt'
config.Data.publishDataName = 'SingleMu_Run2012C_v1'
